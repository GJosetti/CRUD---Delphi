...
begin
  ...
  TFile.WriteAllText('C:\Users\Guilherme Josetti\Desktop\CRUD -- DELPHI\CRUD---Delphi\Arquivos\Estudantes.txt.txt',jsonStr);
end;
...
begin
  ...
  TFile.WriteAllText('C:\Users\Guilherme Josetti\Desktop\CRUD -- DELPHI\CRUD---Delphi\Arquivos\Professores.txt.txt',jsonStr);
end;
...
begin
  ...
  TFile.WriteAllText('C:\Users\Guilherme Josetti\Desktop\CRUD -- DELPHI\CRUD---Delphi\Arquivos\Disciplinas.txt.txt',jsonStr);
end;
...
begin
  ...
  TFile.WriteAllText('C:\Users\Guilherme Josetti\Desktop\CRUD -- DELPHI\CRUD---Delphi\Arquivos\Turmas.txt.txt',jsonStr);
end;
...
begin
  ...
  TFile.WriteAllText('C:\Users\Guilherme Josetti\Desktop\CRUD -- DELPHI\CRUD---Delphi\Arquivos\Matrículas.txt.txt',jsonStr);
end;
